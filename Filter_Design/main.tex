...
\author{Poluri Hemanth \\EE23BTECH11046	}
...
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
Plot fot Figure 3
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/plot2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/plot3.py
\end{lstlisting}
\end{enumerate}
...
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/FIR_1.py
\end{lstlisting}
...
\end{figure}
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/plot4.py
\end{lstlisting}
...
\begin{align}
     \frac{\sin(\omega_{p2} n)}{n\pi} -\frac{\sin\brak{\omega_{p1}n}}{n\pi} &= \frac{2\cos{\brak{\frac{\omega_{p2}n+\omega_{p1}n}{2}}}\sin{\brak{\frac{\omega_{p2}n-\omega_{p1}n}{2}}}}{n\pi}\\
            &= \frac{2\cos{\brak{0.2225n\pi}}\sin{\brak{0.025n\pi}}}{n\pi}
\end{align}
Multipying by window function we get :
\begin{align}
    h_{BP}\brak{n} = 
\begin{cases} 
   \frac{2\cos{\brak{0.2225n\pi}}\sin{\brak{0.025n\pi}}}{n\pi},  & \text{for } -48\leq n \leq 48 \\
    0 &\text{otherwise}
\end{cases} 
\end{align}
...
\end{figure}
\begin{lstlisting}
https://github.com/hemanth23ee/ASSIGNMENTS/blob/main/Filter_Design/codes/plot5.py
\end{lstlisting}
