...
\hhline{|-|-|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{\textbf{Columns}}}
...
\hhline{|----|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$x(0)$=$x(2)$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n\in$R}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{As $x(0)=x(2)$ n can be any real number}}
...
\hhline{|----|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$n=1$}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{As $x(0)\neq x(2)$ n equals 1 to get A.M }}
