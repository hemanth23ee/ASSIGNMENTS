...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{3.5m}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$0.859\cdot10^{6}Hz$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	{\gnumericPB{\centering}\gnumbox{$c$}}             
        &\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$3\cdot10^{6}m/s$}}  
        &\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	{\gnumericPB{\centering}\gnumbox{$\omega$}}             
        &\multicolumn{1}{p{\gnumericColB}|}%
        {\gnumericPB{\centering}\gnumbox{$5.4\cdot10^{6}rad/s$}}  
        &\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
        ...
        &\multicolumn{1}{p{\gnumericColB}|}%
        {\gnumericPB{\centering}\gnumbox{$1.03\cdot10^{-6}T$}}
        &\multicolumn{1}{p{\gnumericColC}|}%
